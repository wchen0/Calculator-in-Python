...
button_add = Button(root, text='+', padx=39, pady=10, command=lambda: button_click('+'))
button_subtract = Button(root, text='-', padx=40, pady=10, command=lambda: button_click('-'))
button_multiply = Button(root, text='*', padx=41, pady=10, command=lambda: button_click('*'))
button_divide = Button(root, text='/', padx=41, pady=10, command=lambda: button_click('/'))

button_equal = Button(root, text=' = ', padx=35, pady=34, command=result)
button_clear = Button(root, text='Clear', padx=28, pady=10, command=button_clear)
button_left_bracket = Button(root, text='(', padx=41, pady=10, command=lambda: button_click('('))
button_right_bracket = Button(root, text=')', padx=41, pady=10, command=lambda: button_click(')'))

button_dot = Button(root, text='.', padx=41, pady=10, command=lambda: button_click('.'))
button_delete = Button(root, text='←', padx=37, pady=10, command=button_delete)
